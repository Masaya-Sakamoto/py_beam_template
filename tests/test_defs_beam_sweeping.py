...
#     beams = def_lin_beams(id_start=2, theta_start_d=1, theta_end_d=25, pattern_rotation_d=90, include_end=True, step=1)
...
#     # beam2: [(27, 1, 135), ..., (51, )]
#     beams_list = [
#         def_lin_beams(id_start=2, theta_start_d=1, theta_end_d=25, pattern_rotation_d=45, include_end=True, step=1),
#         def_lin_beams(id_start=beams_size+2, theta_start_d=1, theta_end_d=25, pattern_rotation_d=45+90, include_end=True, step=1),
#     ]
