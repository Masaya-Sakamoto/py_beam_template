...
def test_def_lin_beams():
    ...
    """
    beams = def_lin_beams(id_start=1, theta_start=0, theta_end=10, phi_const=45, include_end=True,step=2)
    ...
    beams = def_lin_beams(id_start=1, theta_start=0, theta_end=10, phi_const=45, include_end=False, step=2)
    beams_size = len(beams)
