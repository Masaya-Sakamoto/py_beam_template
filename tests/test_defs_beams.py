...
#     """
#     beams = def_lin_beams(id_start=1, theta_start_d=0, theta_end_d=10, pattern_rotation_d=45, include_end=True,step=2)
...
#     beams = def_lin_beams(id_start=1, theta_start_d=0, theta_end_d=10, pattern_rotation_d=45, include_end=False, step=2)
#     beams_size = len(beams)
